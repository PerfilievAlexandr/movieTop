import onePlusOne from './img/1+1.jpg'
import lordOfRings from './img/властелин-колец.jpg'
import gladiator from './img/гладиатор.jpg'
import ringToClouds from './img/достучаться-до-небес.jpg'
import begining from './img/начало.jpg'
import forestGamp from './img/форест-гамп.jpg'
...
export const Articles = [
	{
		...
		top: 9,
		picture: onePlusOne,
		style: ['ужасы', 'комедия', 'фантастика', 'боевик', 'драмма'],
	...
	},
	{
		...
		top: 7,
		picture: lordOfRings,
		style: ['фантастика', 'боевик', 'драмма'],
		text: 'Последняя часть трилогии о Кольце Всевластия и о героях, взявших на себя бремя спасения Средиземья. Повелитель сил Тьмы Саурон направляет свои бесчисленные рати под стены Минас-Тирита, крепости Последней Надежды. Он предвкушает близкую победу, но именно это и мешает ему заметить две крохотные фигурки — хоббитов, приближающихся к Роковой Горе, где им предстоит уничтожить Кольцо Всевластия. Улыбнется ли им счастье?',
